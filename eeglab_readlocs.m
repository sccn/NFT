...
function [eloc, labels, theta, radius, indices] = eeglab_readlocs( filename, varargin ); 
...
if isstr(filename)
   ...
   elseif strcmp(lower(g.filetype(1:end-1)), 'polhemus') | ...
       ...
       try, 
           ...
           [eloc, labels, theta, radius, indices] = eeglab_readlocs( filename, 'defaultelp', 'besa', varargin{:} );
       end;
   else      
       % importing file
       % --------------
