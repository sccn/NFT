% warping_reverse_initial_registration() - Transforms a set of points
%                 using the inverse of scaling, translation and rotation
%                 computed during initial registration
%
%
% Usage:
%   >> Pnew = warping_reverse_initial_registration(sc, T, R, P);
%
% Inputs:
%   sc - scaling (scalar
%   T  - translation [x y z]
...
function Pnew = warping_reverse_initial_registration(sc, T, R, P)
...
x1 = x * cos(alpz) - y * sin(alpz);
y1 = x * sin(alpz) + y * cos(alpz);
z1 = z;
